...
The examples above show the basic approach for moving from site input and model
output data to estimates of commodity requirements and associated costs. More
